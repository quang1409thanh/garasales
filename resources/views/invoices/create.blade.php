    ...
    <div class="modal modal-blur fade" id="modal" tabindex="-1" aria-modal="true" role="dialog">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="payment_type" class="form-label required">
                                        {{ __('Payment') }} <span class="text-danger">*</span>
                                    </label>
                            ...
                            <div class="col-lg-12">
                                ...
                                <input type="number" id="pay" name="pay"
                                       ...
                                       value="{{ Cart::total() }}" readonly required>
                                @error('pay')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <script>
                    // Lấy tham chiếu tới trường payment_type và nút gửi
                    var paymentType = document.getElementById('payment_type');
                    var submitButton = document.getElementById('submit-btn');

                    // Kiểm tra giá trị của payment_type khi có sự thay đổi
                    paymentType.addEventListener('change', function () {
                        // Nếu có giá trị được chọn, kích hoạt nút gửi
                        if (paymentType.value !== '') {
                            submitButton.disabled = false; // Kích hoạt nút gửi
                        } else {
